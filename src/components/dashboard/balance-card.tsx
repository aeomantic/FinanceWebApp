...
export type BalanceAction = "expense" | "income" | "transfer";
  ...
  return (
    <section className="balance-card" aria-labelledby="balance-heading">
      <div className="balance-topline">
        <span className="eyebrow" id="balance-heading">{demo ? "TOTAL BALANCE" : "WALLET BALANCE"}</span>
      ...
      <div className="balance-currency"><span className="currency-flag">{currency === "USD" ? "🇺🇸" : currency === "EUR" ? "🇪🇺" : currency === "GBP" ? "🇬🇧" : "◉"}</span>{currency}<span className="exchange-badge">{demo && currency === "USD" ? "1 USD = EUR 0.95" : "Your wallet, your clarity"}</span></div>
