...
A personal finance webapp with Google-gated login, expense tracking, a wishlist, and recurring monthly payment tracking. See [CLAUDE.md](./CLAUDE.md) for the full build brief.
...
1. Copy `.env.example` to `.env.local` and fill in your Supabase project URL, anon key, service role key, and the allowed Google email.
